...
class BalanceReportsNotifiableModule(AbstractClassNotifiableModule):
    main_model = Report
    module_name = Modules.BALANCE_REPORTS
    ...
    def post_save_signal_handler(sender, instance, **kwargs):
        ...
        if instance.status == 'T':
            ...
            kwargs["notifiable_module"] = BalanceReportsNotifiableModule()
            kwargs["created"] = True
